  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Dawei Directory</div>
      </a>
      ...
      <!-- <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="">Placetype</a>
            <a class="collapse-item" href="">Places</a>
            <a class="collapse-item" href="cards.html">Tickets</a>
          </div>
        </div>
      </li> -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('placetypes.index')}}">Placetype</a>
            <a class="collapse-item" href="{{route('places.index')}}">Places</a>
            <a class="collapse-item" href="{{route('tickets.index')}}">Tickets</a>
          </div>
        </div>
      </li>
