...
@section('content')
	...
	<div class="col-lg-6 col-md-6 col-sm-6">
		<h1 class="h3 mb-2 text-gray-800">Create Placetype</h1>
	</div>
...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form action="{{route('placetypes.store')}}" method="POST" enctype="multipart/form-data">
			@csrf
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="placetypeName" placeholder="Enter Placetype Name" name="name">
				</div>
			</div>
			<div class="form-group row">
